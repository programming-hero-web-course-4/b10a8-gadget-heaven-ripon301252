...
const petDetails = async(pet) => {
    ...
    const {breed, image, gender, price, pet_name, date_of_birth} = data.data
    ...
    modalContainer.innerHTML=`
     <dialog id="my_modal_1" class="modal">
        ...
        <figure class="px-10 pt-10">
            ...
            <h3 class="text-lg font-bold text-center mt-5">${pet_name}</h3>
            <h3 class="text-lg font-bold text-center my-5">${breed}</h3>
            <h3 class="text-lg font-bold text-center">${gender}</h3>
            <h3 class="text-lg font-bold text-center">${price}</h3>
            <h3 class="text-lg font-bold text-center">${date_of_birth}</h3>
